...
import { connection } from './config/database'; //Importando la configuracion de conexion a la BD
import { verify } from 'jsonwebtoken';
const app = express();
app.set('secretKey', 'ClaveSecreta'); // Clave Secreta para nuestro JWT

// Conectando a la base de datos de Mongo
connection.on('error', console.error.bind(console, 'Error de conexion en MongoDB'));
